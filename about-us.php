...
<head>
    ...
    <!-- Title  -->
    <title> Crown Homes | About Us</title>
                        ...
                        <form action="sales.php" method="post" id="advanceSearch">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-4 col-xl-3">
                                    <div class="form-group">
                                        <input type="date"  class="form-control" placeholder="Check-out" required="true" name="check-out"> 
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="about-content">
                        ...
                        <p class="wow fadeInUp" data-wow-delay="450ms">Crown homes is a top-notch real estate company that provides luxury apartments for lodging, primarily home-stays for vacation rentals, and tourism activities via their e-commerce website. <br>

<Strong>Mission statement</strong>Crown homes mission is to help create a world where you can belong anywhere and where people can live in a place, instead of just traveling to it.<br>

<strong>Vision statement </strong>Belong Anywhere
 </p>
                    </div>
                </div>
